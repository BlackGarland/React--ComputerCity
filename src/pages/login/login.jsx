    ...
    handleClick() {
        ...
        .then(data=>{console.log(data)
         ...
         if(this.state.login=="true"){
                ...
                this.props.history.push({pathname:"/" ,search:name});
            }
        }))
        ...
        return (
            <div>
                ...
                <div className="regist">
                    <div className="regist_title">登录联想会员</div>
                    <div className="regist_main">
                        <div className="regist_info_person">
                            ...
                            <div className="regist_item">
                                <input type="password" className="pwd" placeholder="输入密码" onChange={(e) => this.changeData2(e)} />
                                <i className="icon-clear"></i>
                            </div>

                            <a href="#/login" className="regist_button" onClick={this.handleClick.bind(this)}>立即登录</a>
                            <div>
