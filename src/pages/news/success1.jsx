            ...
            <div>
                ...
                <div className="successpage">
                    <div className="mbx-nav">
                        ...
                        <span>首页  品牌  合作伙伴&案例  成功案例  如何利用5G提升古镇运营效率和管理水平，打造旅游古城的新名片？</span>
                    </div>
                    <div className="center-content">
                        ...
                        <div className="pcContent">
                            ...
                            <p>联想通过建设5G网络和行业智能应用，大大提升了丽江古城景区管理工作效率，丰富了景区的娱乐性，提高了丽江古城景区名片的知名度。</p>
                            <h1 className="pcContenth1">客户介绍</h1>
                            <p>丽江古城管理局，希望借助于5G+智能应用手段增强丽江古城的科技感，提升丽江古城在海内外的吸引力和品牌知名度，兼顾采用数字手段加强古城的日常管理。</p>
